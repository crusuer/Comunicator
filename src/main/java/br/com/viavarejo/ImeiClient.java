...
public class ImeiClient {
	...
	public Object getServiceStatus(CemisspSearchInCompany service) {
		...
		JAXBElement<?> result = (JAXBElement<?>) webServiceTemplate.marshalSendAndReceive(root,
	...
	public UnlockBlockOrderServiceResponse unlockBlockOrder(UnlockWSInCompany unblock) {
		...
		JAXBElement<UnlockBlockOrderService> root = objectFactory.createUnlockBlockOrderService(request);
	...
	public CreateBlockOrderUnboundServiceResponse lockBlockOrder(BlockOrderUnboundWSInCompany block) {
		...
		JAXBElement<CreateBlockOrderUnboundService> root = objectFactory.createCreateBlockOrderUnboundService(request);
